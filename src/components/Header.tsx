...
const Header = () => {
  ...
  // ✅ Define college name in one place
  const COLLEGE_NAME = 'Oxford College of Excellence';
  ...
  const studentLinks = [
    `Education at ${COLLEGE_NAME}`,
    'Career Development Cell', 'Incubation Cell',
    ...
    <header className="bg-white shadow-lg sticky top-0 z-50">
      ...
      <div className="bg-blue-900 text-white py-2">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-lg font-bold">{COLLEGE_NAME}</h1>
