          ...
          <div className="space-y-8 animate-fade-in">
            <div className="space-y-6">
              ...
              <p className="text-xl lg:text-2xl text-blue-100 leading-relaxed max-w-xl">
                Empowering students at <strong>Oxford College</strong> with world-class education, cutting-edge research, and industry-ready skills for tomorrow's challenges.
              </p>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button
                size="lg"
                className="bg-gradient-to-r from-yellow-400 to-orange-500 hover:from-yellow-500 hover:to-orange-600 text-black font-semibold px-8 py-4 rounded-full group"
              >
                Explore Programs
